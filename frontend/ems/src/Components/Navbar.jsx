...
      {/* ===== CSV Preview Modal ===== */}
      <Modal show={showModal} onHide={() => setShowModal(false)} size="xl" dialogClassName="custom-modal-width" scrollable>
...
                    <th key={idx} style={{ whiteSpace: 'nowrap' , minWidth: col.toLowerCase().includes('address') ? '400px' : '150px'}}>
...
                        key={colIndex}
                        contentEditable
                        style={{minWidth: field.toLowerCase().includes('address') ? '400px' : '150px',
                          backgroundColor:
