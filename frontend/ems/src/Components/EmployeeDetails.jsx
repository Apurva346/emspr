...
// import axios from 'axios'; // 👈 API call साठी आवश्यक
...
//     useEffect(() => {
//         if (id) {
//             axios.get(`http://localhost:3001/api/employees/${id}`) // 👈 Node.js API endpoint
//                 .then(response => {
...
//     // 💡 Working Mode चा formatSalary फंक्शन कॉल काढून टाकलेला आहे.
...
//                         <p><strong>Working Mode:</strong> {employee.working_mode}</p> {/* 👈 Corrected */}
...
// import { useParams, useNavigate } from 'react-router-dom';
// import { Button } from 'react-bootstrap';
// // 💡 बदला १: 'axios' ऐवजी 'axiosInstance' इम्पोर्ट करा.
// import axiosInstance from '../utils/axiosInstance'; // 👈 तुमच्या project structure नुसार path बदला
// import { formatDate } from '../utils/formatDate';
...
//     useEffect(() => {
//         if (id) {
//             // 💡 बदला २: पूर्ण URL ऐवजी फक्त endpoint वापरा आणि 'axiosInstance' चा वापर करा.
//             axiosInstance.get(`/employees/${id}`) // 👈 Node.js API endpoint (Base URL 'axiosInstance' मधून येईल)
//                 .then(response => {
//                     const data = response.data;
